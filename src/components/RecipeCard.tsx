...
export default function RecipeCard({
  ...
  return (
    <Link href={`/recipes/${recipe.id}`} className="block">
      <div className="bg-white rounded-2xl border border-gray-200 p-5 hover:border-blue-300 transition-colors">
        ...
        <div className="flex items-center gap-4 mt-3 text-xs text-gray-400">
          ...
          <span className="ml-auto text-blue-500">Ver receita →</span>
        </div>
      </div>
    </Link>
  );
